...
const BANK_OPTIONS = [
  { id: 'bca', name: 'Bank BCA', account: '1234567890', holder: 'a.n. Hotel Arca' },
  { id: 'bni', name: 'Bank BNI', account: '0987654321', holder: 'a.n. Hotel Arca' },
  { id: 'mandiri', name: 'Bank Mandiri', account: '1122334455', holder: 'a.n. Hotel Arca' },
];

export default function PaymentPage() {
  return (
    <Suspense fallback={
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, var(--color-blue-deep) 0%, #061924 100%)', color: 'white', fontFamily: 'Inter, sans-serif' }}>
...
function PaymentContent() {
  ...
  useEffect(() => {
    if (booking && allRooms.length > 0) {
      const room = allRooms.find(r => r.id_room === booking.id_room);
