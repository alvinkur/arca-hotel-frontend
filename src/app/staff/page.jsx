  ...
  return (
    <div className="portal-layout">
      ...
      <style jsx>{`
        ...
        .stat-value{font-size:1.7rem;font-weight:700;color:var(--color-blue-deep);line-height:1}        .cc{background:#fff;border-radius:14px;padding:26px;border:1px solid #e8e8e4;box-shadow:0 2px 8px rgba(0,0,0,.03);margin-bottom:22px}
        ...
        .dot-green{background:#16a34a}.dot-red{background:#ef4444}        .table-responsive{width:100%;overflow-x:auto;border-radius:8px}
        ...
        .pill-r{background:#fef2f2;color:#ef4444;border:1px solid #fecaca}        .btn-paid{display:inline-flex;align-items:center;gap:5px;padding:5px 10px;font-size:.73rem;font-weight:600;color:#fff;background:linear-gradient(135deg,#16a34a,#15803d);border:none;border-radius:6px;cursor:pointer;transition:all .2s;white-space:nowrap}
        ...
        .rbc-empty{font-size:.78rem;color:#16a34a;font-style:italic;padding:8px 0}        .empty-state{padding:40px 20px;text-align:center;color:#9ca3af;background:#fafaf9;border-radius:10px;border:1px dashed #d1d5db}
